...
export default function TrainingsScreen() {
  ...
  const { clients, fetchClients } = useUsers()
  ...
  const [filters, setFilters] = useState<FilterState>({ name: '', userId: '' })
  ...
  const openCreateModal = () => {
    ...
    setFormData({ name: '', description: '', userId: undefined })
  ...
  const openEditModal = (training: Training) => {
    ...
    setFormData({
      ...
      userId: training.userId ?? training.user?.id,
    })
    setIsFormModalVisible(true)
  }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          >
            ...
            >
              <TouchableOpacity onPress={() => setSelectedTraining(null)}>
                <Text style={[localStyles.headerSideBtn, { color: colors.error }]}>
                  Fechar
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[localStyles.headerSideBtn, { color: colors.primary }]}>
                  + Adicionar
                </Text>
              </TouchableOpacity>
            </View>
      ...
      <TrainingFormModal
        ...
        onUserChange={(uid) =>
          setFormData((prev) => ({ ...prev, userId: uid ?? undefined }))
        }
      />
